...
#         self.client = APIClient()
#
#     @patch('your_app.views.send_email_task.delay')
#     def test_send_notification(self, mock_send_email_task):
#         """Test sending a notification via Celery"""
#         res = self.client.get(SEND_NOTIFICATION_URL)
#
#         self.assertEqual(res.status_code, status.HTTP_200_OK)
...
#         )
#         self.assertEqual(res.data, {"status": "Notification sent"})
#
